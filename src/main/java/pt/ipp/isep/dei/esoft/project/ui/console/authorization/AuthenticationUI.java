...
public class AuthenticationUI implements Runnable {
    ...
    private List<MenuItem> getMenuItemForRoles() {
        ...
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_CLIENT, new ClientGUI()));
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_NETWORKMANAGER, new NetworkGUI()));
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_STOREMANAGER, new StoreGUI()));
